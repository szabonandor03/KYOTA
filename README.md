...
3. Ask the operator a few short questions about what they are thinking about, what outcome matters, and what should be excluded.
4. Choose a context budget: `tight`, `standard`, or `large`.
5. Select only the files needed for the task.
6. Then generate or execute.
